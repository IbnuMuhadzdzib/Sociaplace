...
$userId = $_SESSION['id'];
$query = mysqli_query($connect,"SELECT username FROM users WHERE id='$userId'");
...
<hr>
    ...
    <div class="index__title">
        <h1 class="title__text" >Welcome <span><?=$username?>,</span> go ahead and get the big <span>Bucks</span></h1>
    </div>
...
<div class="hero">
    ...
    <button class="wrapper__btn" onclick="pindahPage3()" >
        <div class="card">
            <div class="icon-container">
    ...
    <button class="wrapper__btn" onclick="pindahPage5()" >
        <div class="card">
            <div class="icon-container">
...
function toggleMenu() {
    ...
    function pindahPage() {
        window.location.href='Main/Seller/add-product.php'
    }
    ...
    function pindahPage2() {
        window.location.href='Main/Seller/my-product.php'
    }
